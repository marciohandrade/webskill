    ...
    <div class="document">
        ...
        <div class="cover-page">
            <div class="cover-content">
                ...
                <h2 class="cover-subtitle" style="color: white;">Metodologia Avançada para o Setor de Estética e Saúde</h2>
        ...
        <div class="page">
            ...
            <div class="cta-section">
                ...
                <p class="cta-subtitle" style="color: white;">A próxima geração em gestão de relacionamento com clientes inativos</p>
                
                <div class="cta-features">
                    <div class="cta-feature">
                        <h4>🎯 Identificação Automática</h4>
                        <p style="color: white; text-align: left; line-height: 1.5;">Sistema detecta automaticamente clientes em risco de abandono com 94% de precisão, acionando protocolos preventivos.</p>
                    </div>
                    <div class="cta-feature">
                        <h4>📱 Comunicação Personalizada</h4>
                        <p style="color: white; text-align: left; line-height: 1.5;">Mensagens adaptadas automaticamente baseadas em histórico, comportamento e perfil psicológico do cliente.</p>
                    </div>
                    <div class="cta-feature">
                        <h4>📊 Analytics Avançado</h4>
                        <p style="color: white; text-align: left; line-height: 1.5;">Dashboard em tempo real com métricas preditivas e otimização contínua baseada em machine learning.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 20px 0 30px 0;">
                    <div style="background: rgba(255,102,0,0.15); padding: 20px; border-radius: 8px; text-align: center; border: 1px solid rgba(255,102,0,0.2);">
                        ...
                        <div style="font-size: 14px;">Aumento na Taxa de Reativação</div>
                    </div>
                    <div style="background: rgba(255,102,0,0.15); padding: 20px; border-radius: 8px; text-align: center; border: 1px solid rgba(255,102,0,0.2);">
                        <div style="font-size: 24px; font-weight: 700; margin-bottom: 8px; color: #ff6600;">-78%</div>
                        <div style="font-size: 14px;">Redução no Tempo de Implementação</div>
                    </div>
                    <div style="background: rgba(255,102,0,0.15); padding: 20px; border-radius: 8px; text-align: center; border: 1px solid rgba(255,102,0,0.2);">
                        <div style="font-size: 24px; font-weight: 700; margin-bottom: 8px; color: #ff6600;">+1.200%</div>
                        <div style="font-size: 14px;">ROI com Sistema Automatizado</div>
                    </div>
                </div>
            </div>
        ...
        <div class="page">
            ...
            <div class="cta-section" style="margin-top: 40px;">
                ...
                <div style="margin: 30px 0;">
                    <p style="font-size: 18px; margin-bottom: 20px;"><strong>Investimento que se paga em 15 dias.</strong></p>
                    <p style="font-size: 16px; opacity: 0.9;">Consultoria + Implementação + Sistema Automatizado</p>
                </div>
                
                <div style="margin-top: 40px;">
                    <p style="font-size: 20px; font-weight: 600; margin-bottom: 10px; color: #ff6600;">📞 AGENDE SUA CONSULTORIA ESTRATÉGICA</p>
                    <p style="font-size: 16px; opacity: 0.9;">Análise gratuita do potencial de recuperação do seu negócio</p>
                </div>
            </div>
